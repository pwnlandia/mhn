...
Please be aware that by default the MHN server web app is communicating
plaintext. To change that, install SSL/TLS certificates to your nginx. Proper
configuration can be found at [bettercrypto.org](https://bettercrypto.org)
...
Same applies to the honeymap running on port 3000. It might be helpful to
install iptables rules to restrict access to the honeymap.
