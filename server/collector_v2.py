...
def main():
    ...
    ensure_user_permissions(cfg['IDENT'], cfg['SECRET'], [], cfg['CHANNELS'], cfg['MONGO_HOST'], cfg['MONGO_PORT'], cfg['MONGO_AUTH'], cfg['MONGO_USER'], cfg['MONGO_PASSWORD'], cfg['MONGO_AUTH_MECHANISM'])
