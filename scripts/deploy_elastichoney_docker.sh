...
docker pull threatstream/elastichoney
...
command=docker run -p 9200:9200 -p 10000:10000 -v /opt/elastichoney:/etc/elastichoney threatstream/elastichoney:latest
